...
class Chat:
    ...
    def answer_prepare(self, conv, img_list, max_new_tokens=300, num_beams=1, min_length=1, top_p=0.9,
                       repetition_penalty=1.05, length_penalty=1, do_sample=True, temperature=1.0, max_length=2000,
                       output_logits=True, output_attentions=True, output_hidden_states=True, return_dict_in_generate=True):
        ...
        generation_kwargs = dict(
            inputs_embeds=embs,
            max_length=max_new_tokens,   ######################## updated
            stopping_criteria=self.stopping_criteria,
            num_beams=num_beams,
            do_sample=do_sample,   ######################## updated
    ...
    def answer(self, conv, img_list, **kargs):
        ...
        output_token = self.model_generate(**generation_dict)[0][0]
    ...
    ######################## updated
    def generate(self, conv, img_list, **kargs):
        generation_dict = self.answer_prepare(conv, img_list, **kargs)
