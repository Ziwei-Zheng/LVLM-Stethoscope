...
class MiniGPT4(MiniGPTBase):
    ...
    def init_Qformer(cls, num_query_token, vision_width, freeze):
        encoder_config = BertConfig.from_pretrained("/workspace/bert-base-uncased")
    ...
    def encode_img(self, image):
        ...
        with self.maybe_autocast():
            image_embeds = self.ln_vision(self.visual_encoder(image)).to(device)   # (1,3,224,224) -> (1,257,1408)
            if self.has_qformer:
                ...
                query_output = self.Qformer.bert(
                    ...
                    output_attentions=True,    ################################## updated
                    return_dict=True,
                )
