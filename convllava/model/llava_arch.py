...
from convllava.constants import IGNORE_INDEX, IMAGE_TOKEN_INDEX, DEFAULT_IMAGE_PATCH_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN

from convllava.mm_utils import get_anyres_image_grid_shape
...
class LlavaMetaModel:
    ...
    def initialize_vision_modules(self, model_args, fsdp=None):
        ...
        print(
            f"llava_arch file self.get_vision_tower() = {self.get_vision_tower()}")
...
class LlavaMetaForCausalLM(ABC):
    ...
    def encode_images(self, images):
        ...
        if self.model.vision_tower.part_on_cpu:
            image_features = image_features.to('cuda',dtype=torch.float16) ############
